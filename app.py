...
<div class="disclaimer-box">
    ...
    not legal advice. Always consult a qualified solicitor for advice specific to your situation.
    In an emergency call 999. For legal aid visit <strong>gov.uk/legal-aid</strong>
</div>
""", unsafe_allow_html=True)
